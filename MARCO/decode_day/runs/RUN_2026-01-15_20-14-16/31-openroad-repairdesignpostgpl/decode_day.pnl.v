module decode_day (am_pm,
 ...
 sky130_fd_sc_hd__or3_1 _10_ (.A(_01_),
    ...
    .VPWR(VPWR),
    .X(net8));
 sky130_fd_sc_hd__conb_1 decode_day_15 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net15));
 sky130_fd_sc_hd__conb_1 decode_day_16 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net16));
 sky130_fd_sc_hd__conb_1 decode_day_17 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net17));
 sky130_fd_sc_hd__conb_1 decode_day_13 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net13));
 sky130_fd_sc_hd__conb_1 decode_day_14 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net14));
 ...
 sky130_fd_sc_hd__buf_2 output11 (.A(net11),
    ...
    .VPWR(VPWR),
    .X(hour_num[4]));
 sky130_fd_sc_hd__conb_1 decode_day_12 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net12));
