module decode_all (VGND,
 ...
 sky130_fd_sc_hd__a22o_1 _471_ (.A1(net64),
    ...
    .VPWR(VPWR),
    .X(net61));
 sky130_fd_sc_hd__conb_1 decode_all_114 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net114));
 sky130_fd_sc_hd__conb_1 decode_all_115 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net115));
 sky130_fd_sc_hd__conb_1 decode_all_116 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net116));
 sky130_fd_sc_hd__conb_1 decode_all_117 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net117));
 ...
 sky130_fd_sc_hd__buf_2 output112 (.A(net112),
    ...
    .VPWR(VPWR),
    .X(led_year[9]));
 sky130_fd_sc_hd__conb_1 decode_all_113 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net113));
