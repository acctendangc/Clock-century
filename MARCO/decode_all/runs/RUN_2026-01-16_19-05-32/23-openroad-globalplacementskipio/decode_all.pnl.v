module decode_all (VGND,
 ...
 sky130_fd_sc_hd__a22o_2 _471_ (.A1(led_min[13]),
    ...
    .VPWR(VPWR),
    .X(led_min[10]));
 sky130_fd_sc_hd__conb_1 _472_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(led_month[13]));
 sky130_fd_sc_hd__conb_1 _473_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(led_month[8]));
 sky130_fd_sc_hd__conb_1 _474_ (.VGND(VGND),
    ...
    .VPWR(VPWR),
    .LO(led_month[9]));
 sky130_fd_sc_hd__conb_1 _475_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(led_day[8]));
 sky130_fd_sc_hd__conb_1 _476_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(led_hour[8]));
