module counter_all (clk,
 ...
 sky130_fd_sc_hd__or4_1 _586_ (.A(net55),
    ...
    .VPWR(VPWR),
    .X(_277_));
 sky130_fd_sc_hd__a21bo_1 _587_ (.A1(net55),
    .A2(_276_),
    .B1_N(_277_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xor2_1 _597_ (.A(_278_),
    ...
    .VPWR(VPWR),
    .X(_286_));
 sky130_fd_sc_hd__mux2_1 _598_ (.A0(net61),
    .A1(_286_),
    .S(_281_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a22o_1 _621_ (.A1(_281_),
    ...
    .VPWR(VPWR),
    .X(_032_));
 sky130_fd_sc_hd__dfstp_1 _622_ (.CLK(clk),
    .D(_000_),
    .SET_B(net76),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net56));
 sky130_fd_sc_hd__dfrtp_4 _623_ (.CLK(clk),
    .D(_001_),
    .RESET_B(net76),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _624_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(net58));
 sky130_fd_sc_hd__dfrtp_4 _625_ (.CLK(clk),
    .D(_003_),
    .RESET_B(net76),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net59));
 sky130_fd_sc_hd__dfrtp_4 _626_ (.CLK(clk),
    .D(_004_),
    .RESET_B(net78),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _627_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(net46));
 sky130_fd_sc_hd__dfrtp_4 _628_ (.CLK(clk),
    .D(_006_),
    .RESET_B(net78),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _629_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(net48));
 sky130_fd_sc_hd__dfrtp_4 _630_ (.CLK(clk),
    .D(_008_),
    .RESET_B(net79),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net49));
 sky130_fd_sc_hd__dfstp_1 _631_ (.CLK(clk),
    .D(_009_),
    .SET_B(net76),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net30));
 sky130_fd_sc_hd__dfrtp_4 _632_ (.CLK(clk),
    .D(_010_),
    .RESET_B(net76),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net31));
 sky130_fd_sc_hd__dfrtp_4 _633_ (.CLK(clk),
    .D(_011_),
    .RESET_B(net76),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _634_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(net33));
 sky130_fd_sc_hd__dfrtp_4 _635_ (.CLK(clk),
    .D(_013_),
    .RESET_B(net76),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _642_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(net72));
 sky130_fd_sc_hd__dfrtp_4 _643_ (.CLK(clk),
    .D(_021_),
    .RESET_B(net77),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _644_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(net51));
 sky130_fd_sc_hd__dfrtp_4 _645_ (.CLK(clk),
    .D(_023_),
    .RESET_B(net76),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _650_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(net61));
 sky130_fd_sc_hd__dfrtp_4 _651_ (.CLK(clk),
    .D(_029_),
    .RESET_B(net78),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _652_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(net63));
 sky130_fd_sc_hd__dfrtp_4 _653_ (.CLK(clk),
    .D(_031_),
    .RESET_B(net78),
    .VGND(VGND),
    .VNB(VGND),
