module clock_century (alarm_i,
 ...
 alarm alarm_inst (.alarm_i(alarm_i),
    .alarm_o(alarm_o),
    .clk(clk),
    .rst_n(reset_n),
    ...
    \minute[1] ,
    \minute[0] }));
 counter_all counter_all_inst (.clk(clk),
    .reset_n(reset_n),
    .day({\day[4] ,
    \day[3] ,
    \day[2] ,
 ...
 decode_all decode_all_inst (.day({\day[4] ,
    ...
    \year[1] ,
    \year[0] }));
 decode_day decode_day_inst (.am_pm(am_pm),
    .day_num({\day_num[4] ,
    \day_num[3] ,
    \day_num[2] ,
    \day_num[1] ,
    ...
    \year[1] ,
    \year[0] }));
 decode_input decode_input_inst (.button_dec(button_dec),
